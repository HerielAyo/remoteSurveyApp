...
export default function ExplanationQuestion({navigation}){
    const [explanationQuestionText, setExplanationQuestionText] = useState('')

    const handleText = (text)=>(
        setExplanationQuestionText(text)
    )

    function onSubmitQuestion(){
        db.ref('/questions/').push({type:'explanationText', questionText:explanationQuestionText});
